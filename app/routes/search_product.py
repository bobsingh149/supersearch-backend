    ...
    for filter_condition in filters.conditions:
        ...
        if operator == "eq":
            ...
            if isinstance(value, list):
                ...
                conditions.append(f"id @@@ paradedb.match(field => 'searchable_content', value => '{query_text}')")
            else:
                conditions.append(f"id @@@ paradedb.match(field => 'searchable_content', value => '{value}')")
